...
import { IAddTeamMemberForm, ITeamMember, ITeamStats } from 'types/team'
import { demoTeamMembers, demoTeamStats } from 'data/demo-team'
import { RiAddLine, RiFilterLine, RiTeamLine } from 'react-icons/ri'
		...
		<div className="p-6 max-w-7xl mx-auto">
			<div className="mb-8">
				...
				<p className="text-gray-600 text-lg">
					Manage your team members, view statistics, and control access
					permissions.
				</p>
			</div>
