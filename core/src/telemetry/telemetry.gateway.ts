...
export class TelemetryGateway {
  ...
  @ApiOperation({
    ...
    description: 'Sends new telemetry data to all connected clients and saves it to the database. This event is used to broadcast real-time IoT sensor data to all subscribers.',
    externalDocs: {
  ...
  @ApiOperation({
    ...
    description: 'Subscribes the client to receive real-time telemetry data updates. After subscribing, the client will receive all new telemetry data via the "telemetry:new" event.',
    externalDocs: {
  ...
  @ApiOperation({
    ...
    description: 'Unsubscribes the client from receiving telemetry data updates. The client will no longer receive "telemetry:new" events.',
    externalDocs: {
      description: 'Socket.IO rooms documentation',
      url: 'https://socket.io/docs/v4/rooms/'
    }
